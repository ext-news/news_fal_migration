 ...
 *
 */
class NewsCategoryMigrationCommandController extends CommandController
{
    ...
    {
        $updatedRecords = 0;
        $toUpdate = $this->databaseConnection->exec_SELECTgetRows('uid, parentcategory',
    ...
    {
        $newMmCount = 0;
        $oldMmRecords = $this->databaseConnection->exec_SELECTgetRows('uid_local, uid_foreign, tablenames, sorting',
